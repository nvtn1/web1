<template>
  <div id="contact" class="flex items-center">
    ...
    <a
      ...
      target="blank"
      class="w-10 h-10 mr-3 rounded-full flex justify-center items-center opacity-50 hover:opacity-100 hover:border-yell hover:bg-yell"
    >
      <svg
        role="img"
        width="30"
    ...
    <!-- github -->
    <a
      href="https://github.com/nvtn1"
      target="blank"
      class="w-10 h-10 mr-3 rounded-full flex justify-center items-center opacity-70 hover:opacity-100 hover:border-v1o hover:bg-v1o"
    >
      <svg
        role="img"
        width="30"
    ...
    >
      <div
        class="container w-[280px] h-[180px] opacity-90 border border-zinc-800 bg-zinc-900 rounded-xl shadow-xl"
      >
        ...
        <div class="font-base text-primary">
          <h2 class="font-bold text-2xl mb-2">My Contact</h2>
          <h2 class="font-bold">Call Me</h2>
          <p class="pt-1 mb-1">083151859420</p>
          <h2 class="font-bold">Email Me</h2>
          <p class="pt-1">novantinodw@gmail.com</p>
        </div>
      </div>
    </div>
  </div>
